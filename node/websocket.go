...
func (t *websocketTransport) nextID() jsonrpc.ID {
	return jsonrpc.ID{
		Num: atomic.AddUint64(&t.counter, 1),
	}
}

func (t *websocketTransport) Request(ctx context.Context, r *jsonrpc.Request) (*jsonrpc.RawResponse, error) {
...
func (t *websocketTransport) Subscribe(ctx context.Context, r *jsonrpc.Request) (Subscription, error) {
