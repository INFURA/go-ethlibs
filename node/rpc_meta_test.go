...
// func TestMetaRpc_Call_Simple_Contract(t *testing.T) {
...
func TestMetaRpc_Get_Accounts(t *testing.T) {
	ctx := context.Background()
	conn := getMetaDevClient(t, ctx)

	accountList, err := conn.GetAccounts(ctx)
	println("accountList: ", accountList)
	require.NoError(t, err)
	require.Equal(t, accountList[0], eth.Address(ALICE))
}

func TestMetaRpc_Get_Balance(t *testing.T) {
	ctx := context.Background()
	conn := getMetaDevClient(t, ctx)
...
// todo
// func TestMetaRpc_GetTransactionCount(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// error
// func TestMetaRpc_EstimateGas(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// error
// func TestMetaRpc_MaxPriorityFeePerGas(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
func TestMetaRpc_GasPrice(t *testing.T) {
	ctx := context.Background()
	conn := getMetaDevClient(t, ctx)
	...
	gasP, _ := strconv.ParseUint("0x2540be400", 10, 64)
	println("gasP: ", gasP)
	// require.Equal(t, gasPrice, uint64("0x2540be400")) // 10_000_000_000
}

func TestMetaRpc_NetVersion(t *testing.T) {
	ctx := context.Background()
	conn := getMetaDevClient(t, ctx)
...
// func TestMetaRpc_ChainId(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// func TestMetaRpc_SendRawTransactionInValidEmpty(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// func TestMetaRpc_SendRawTransactionInValidOldNonce(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// func TestMetaRpc_FutureBlockByNumber(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// func TestMetaRpc_InvalidBlockByHash(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
...
// func TestMetaRpc_InvalidTransactionByHash(t *testing.T) {
// 	ctx := context.Background()
// 	conn := getMetaDevClient(t, ctx)
