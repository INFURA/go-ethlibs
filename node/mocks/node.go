...
import (
	...
	node "github.com/ConsenSys/go-ethlibs/node"
...
func (m *MockClient) NetPeerCount(ctx context.Context) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NetPeerCount", ctx)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockClientMockRecorder) NetPeerCount(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NetPeerCount", reflect.TypeOf((*MockClient)(nil).NetPeerCount), ctx)
}
